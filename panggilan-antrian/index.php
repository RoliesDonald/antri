...
<body class="d-flex flex-column h-100">
  <main class="flex-shrink-0">
    <div class="container pt-4">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 .bg-warning.bg-gradient
 rounded-2 shadow-sm">
        <!-- judul halaman -->
        <div class="d-flex align-items-center me-md-auto">
          <i class="bi-mic-fill text-white me-3 fs-3"></i>
        ...
        <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="http://www.indrasatya.com/"><i class="bi-house-fill text-white"></i></a></li>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container-fluid">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2022 - <a href="https://www.linkedin.com/in/rolies-donald-665a632a/" class="text-decoration-none fw-bold text-info">Rolies Donald</a> for <a href="https://www.polresmesuji.com/" class="text-decoration-none fw-bold text-warning">POLRES MESUJI </a>
      </div>
    </div>
  </footer>
